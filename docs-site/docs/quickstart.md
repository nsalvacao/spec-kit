# Quick Start Guide (Fork)

This guide helps you get started with the forked Spec Kit workflow, which includes **Phase 0** before Spec‑Driven Development.

> [!NOTE]
> All automation scripts now provide both Bash (`.sh`) and PowerShell (`.ps1`) variants. The `specify` CLI auto-selects based on OS unless you pass `--script sh|ps`.

## The 7-Step Process (Phase 0 + SDD)
...
```bash
uvx --from git+https://github.com/nsalvacao/spec-kit.git specify init <PROJECT_NAME> --script ps  # Force PowerShell
...
- Read the [methodology](./methodology.md) for philosophy and workflow rationale
- Read the [walkthrough](./walkthrough.md) for the full step-by-step process
- Explore the [source code on GitHub](https://github.com/nsalvacao/spec-kit)
